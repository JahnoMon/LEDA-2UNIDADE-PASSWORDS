...
import useCases.CriarCasosPorData;
import useCases.CriarCasosPorTamanho;
import useCases.CriarCasosPorMes;
...
public class RunTestes {
    private final HashMap<String, AlgoritmoDeOrdenação> algorithms = new LinkedHashMap<>();
    private final HashMap<String, HashMap<String, Supplier<String[]>>> cases = new LinkedHashMap<>();

    public void setCases() {
        var byLength = new CriarCasosPorTamanho();
        var byDate = new CriarCasosPorData();
        var byMonth = new CriarCasosPorMes();
    ...
    private void showResults() {
        ...
        for (var entry : cases.entrySet()) {
            ...
            for (var entry2 : algorithms.entrySet()) {
                ...
                AlgoritmoDeOrdenação algorithm = entry2.getValue();

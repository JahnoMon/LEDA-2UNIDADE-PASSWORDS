...
public class QuickSortMedianaTres extends AlgoritmoDeOrdenação {
    ...
    public void tamanho(String[] data, String nameCase) {
        ...
        System.out.println(
                "Tempo de execução Quick Sort (Mediana de 3) p/ o " + nameCase + ": " + duration + " milissegundos");
        String filename = "";
    ...
    private void quickSortLength(String[] array, int inicio, int fim, varInput v) {
        if (inicio < fim) {
    ...
    private int partitionLength(String[] array, int inicio, int fim, varInput v) {

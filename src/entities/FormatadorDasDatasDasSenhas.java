...
public class FormatadorDasDatasDasSenhas {
        ...
        try (BufferedReader br = new BufferedReader(new FileReader(inputFile));
            ...
            while ((line = br.readLine()) != null) {
                ...
                if (data.length >= 4) {
                    ...
                    writer.append(String.valueOf(lineNumber - 1)).append(",").append(
                            String.join(",", csvQuotedBy + data[1] + csvQuotedBy, data[2], formattedDate, data[4]));
                    writer.append("\n");
                }
            }
